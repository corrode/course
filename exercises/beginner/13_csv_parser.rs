...
//!
//! Parse CSV (Comma-Separated Values) files with proper quoting support.
//! This is the most challenging exercise - it combines everything you've learned!
...
fn csv_to_records(headers: &[String], rows: &[Vec<String>]) -> Vec<std::collections::HashMap<String, String>> {
    unimplemented!()
}
