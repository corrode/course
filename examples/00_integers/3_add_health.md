...
A `u8` holds 0 to 255.
Add 100 to 200 and a debug build panics, while a release build wraps to 44.
...
- [`u8::saturating_add`](https://doc.rust-lang.org/std/primitive.u8.html#method.saturating_add) returns the sum, or the type's maximum if the true sum wouldn't fit.
