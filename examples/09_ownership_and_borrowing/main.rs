...
// own eyes, so the compiler messages feel familiar later (chapter 11,
// chapter 13, …) instead of like a brick wall.
//
// Uncomment one experiment at a time, run the tests, read the error,
// then comment it out again before moving on. The errors are the lesson.
// =====================================================================
