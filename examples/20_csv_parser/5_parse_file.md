...
- [`str::lines`](https://doc.rust-lang.org/std/primitive.str.html#method.lines)
  ...
  trailing newline does not create an empty trailing line.
- [`Iterator::next`](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.next)
  on the iterator pulls off the header line; an empty file should
  return empty headers and rows.
...
- [`Iterator::collect`](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.collect)
  to materialize both the headers and the rows into `Vec`s.
