...
- [`str::len`](https://doc.rust-lang.org/std/primitive.str.html#method.len) returns the *byte* length.
  Reach for `chars().count()` when you mean "how many `char` values?"
  The two answers differ as soon as a non-ASCII character shows up.
