...
///
/// The bonus is a percentage *added on top* of the base, so `50.0` means
/// "+50%": a base of `100` becomes `150`. Think of it as a critical-hit bonus,
/// an equipment buff, or any other damage modifier expressed as a percentage.
...
fn test_damage_with_bonus() {
    ...
    // Fractional HP truncates toward zero: 7 + 7 * 0.155 = 8.085 → 8, not 9.
