/// Ferris the crab has moods.
/// Decide which one based on how hungry he is (a `0..=10` scale) and how many naps he's had today.
///
/// The rules, in plain English:
///
/// - If Ferris is **very** hungry (8 or more), he's `"Hangry"`, no matter how many naps he's had.
/// - Otherwise, if he's also a bit hungry (5 or more) **and** has had no naps, he's `"Grumpy"`.
...
/// The order of the branches matters; the tests include cases where more than one condition is true.
