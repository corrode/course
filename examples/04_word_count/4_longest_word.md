...
This is the manual version of "max by some property". Chapter 16
("Iterators") shows it as a one-liner; doing it once by hand makes
the shortcut feel like a reward rather than magic.
...
- [`str::chars`](https://doc.rust-lang.org/std/primitive.str.html#method.chars)
  ...
  Using `word.len()` would return the *byte* length, which differs
  from the character count for accented or non-Latin text.
