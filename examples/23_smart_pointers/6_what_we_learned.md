...
You boxed an integer and added it back out, then used `Box` to make a recursive expression tree possible.
Finally, you threaded a string through different command types stored behind `Box<dyn Command>`.
