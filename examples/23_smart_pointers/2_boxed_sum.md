...
[`Box::new(value)`](https://doc.rust-lang.org/std/boxed/struct.Box.html#method.new)
...
You usually wouldn't box a tiny integer. This warmup lets you practice reading
through a box before using one to own recursive data or a trait object.
