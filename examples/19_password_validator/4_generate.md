...
- Make sure each class appears at least once so the result will pass strength checks regardless of `length` (assume `length >= 4`).
...
- [`std::time::SystemTime::now`](https://doc.rust-lang.org/std/time/struct.SystemTime.html#method.now) and [`Duration::subsec_nanos`](https://doc.rust-lang.org/std/time/struct.Duration.html#method.subsec_nanos) give you a time-based `u32` you can use for the cycling index.
- [`String::with_capacity`](https://doc.rust-lang.org/std/string/struct.String.html#method.with_capacity) pre-allocates the buffer if you know the final length up front.
