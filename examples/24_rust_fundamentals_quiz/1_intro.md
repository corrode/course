...
These are twenty-one multiple-choice questions about the topics from the previous chapters: ownership and borrowing, `Option` and `Result`, lifetimes, traits, enums, modules.
