...
This is the exact same pattern you'll see in the `?` operator chapter as `Box<dyn Error>`: "some value, I don't care which concrete type, just give me one owned thing that implements the trait."
