...
- [`next`](https://doc.rust-lang.org/std/iter/trait.Iterator.html#tymethod.next)
  asks for one item and returns an `Option`.
- [`by_ref`](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.by_ref)
  lets a consumer borrow an iterator so you can use it again afterward.
- [`take`](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.take)
  limits how many items its consumer can request.

Does asking for one filtered result visit just one input? After collecting the
