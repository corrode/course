...
impl User {
    ...
    /// verification flag is idempotent: setting it on every login is fine
    /// because once you're verified you stay verified. (A real system would
    /// only set it on first login; we keep it simple here.)
